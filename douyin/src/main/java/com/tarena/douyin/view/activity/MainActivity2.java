...
import com.tarena.douyin.view.widget.FullViewPager;
 ...
 * @author kakrot
 */
public class MainActivity2 extends AppCompatActivity implements ScaleScrollView.OnScrollChangeListener {
    ...
    private void initView() {
     ...
     //   getWindow().setNavigationBarColor(colorPrimary);
       ...
       /* viewPager.setAdapter(new TabAdapter(this, getSupportFragmentManager(), getTabs()));
        ...
        viewPager.setAdapter(new CommPagerAdapter(getSupportFragmentManager(), fragments, titles));
        tab1.setupWithViewPager(viewPager);
    }
