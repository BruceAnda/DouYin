...
public class BaseConstants {
    ...
    public static final int[] PROP_IMAGES = {R.drawable.prop_2d, R.drawable.prop_3d, R.drawable.prop_forword,
            R.drawable.prop_back, R.drawable.prop_eye, R.drawable.prop_mouth,
            R.drawable.prop_head, R.drawable.prop_hand};
