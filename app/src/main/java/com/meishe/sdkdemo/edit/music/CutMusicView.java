 ...
 * note: 此控件中的所有时间，均是微秒
 * Note: All times in this control are microseconds
 */
...
public class CutMusicView extends RelativeLayout {
    ...
    private int getTouchMode(float x, float y) {
        ...
        /*
        * m_touchWidth是为了增加touch区间，使触摸更加敏感
        * m_touchWidth is to increase the touch interval and make the touch more sensitive
        * */
