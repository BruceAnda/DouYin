...
//    private NvsTimelineAnimatedSticker logo_douyin;
...
//                logo_douyin = addLogoWaterMark(getBaseContext(), mStreamingContext, mTimeline);
...
//        assert logo_douyin != null;
//        removeLogoSticker(logo_douyin, mTimeline);
        mLiveWindow.playVideo(mTimeline);
    }
