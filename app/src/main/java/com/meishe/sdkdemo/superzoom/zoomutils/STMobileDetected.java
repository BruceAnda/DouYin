...
//    private STMobileStickerNative mStStickerNative = new STMobileStickerNative();
    ...
    public boolean initSTMobileDetected(Context context) {
        ...
        * Read the model from the asset resource folder into memory, and then use the underlying
        * st_mobile_human_action_create_from_buffer interface to create a handle
        * */
    ...
    private int getHumanActionOrientation(int cameraOrientation, boolean flipHorizontal) {
        ...
        * When using a rear camera and the sensor orientation is 0 or 2, the rear camera is opposite to the front orentation
        * */
        ...
        * Please note that the front camera and the rear camera have different rotation definitions,
        * and different mobile phone camera rotation definitions are different.
        * */
