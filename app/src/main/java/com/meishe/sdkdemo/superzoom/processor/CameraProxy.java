...
public class CameraProxy {
    ...
    public int getDisplayOrientation(int dir) {
        /**
         * 请注意：前置摄像头与后置摄像头旋转定义不同，不同手机摄像头旋转定义不同
         * Please note: the front camera and the rear camera have different rotation definitions,
         * and different mobile phones have different camera rotation definitions
         */
        int newdir = dir;
        if (isFrontCamera() &&
