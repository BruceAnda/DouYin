...
public class GridSpacingItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridSpacingItemDecoration(Context context, int spanCount) {
        ...
        int marginSizeLeftAndRight = (int) MeicamContextWrap.getInstance().getContext().getResources().getDimension(R.dimen.select_recycle_marginLeftAndRight);
        marginSizeStart = (int) MeicamContextWrap.getInstance().getContext().getResources().getDimension(R.dimen.select_item_start_end);
        marginSizeMiddle = (int) MeicamContextWrap.getInstance().getContext().getResources().getDimension(R.dimen.select_item_between);
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        int startSpace = ScreenUtils.dip2px(MeicamContextWrap.getInstance().getContext(), 3);
