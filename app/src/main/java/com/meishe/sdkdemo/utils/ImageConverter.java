...
public class ImageConverter {
    ...
    public static Bitmap convertImage(Context context, String srcImageFilePath) {
        ...
        if (srcImageFilePath.contains("assets:/watermark/")) {
            ...
            if (srcImageFilePath.contains(CONTENT_START)){
                Uri uri = Uri.parse(srcImageFilePath);
                srcImageFilePath = getFilePathFromContentUri(uri, context.getContentResolver());
            }
    ...
    public static Point getPicturePoint(String filePath, Context context) {
        if (filePath != null) {
            if (filePath.contains("assets:/watermark/")) {
                ...
                BitmapFactory.Options opt = new BitmapFactory.Options();
                opt.inJustDecodeBounds = true;
                if (filePath.contains(CONTENT_START)){
                    Uri uri = Uri.parse(filePath);
                    filePath = getFilePathFromContentUri(uri, context.getContentResolver());
                }
